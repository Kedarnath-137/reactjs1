...
const Empolyee = () =>{
    const[curr,setCurr]=useState([{
        name:"kedar",designation:"frontend",salary:30000},{
            name:"aravind",designation:"frontend",salary:35000
        },
    ])   

    const addEmpolyee = () =>{
       let newEmployee = [...curr,{name:"sai",designation:"frontend",salary:40000}]
        setCurr(newEmployee)
    }
