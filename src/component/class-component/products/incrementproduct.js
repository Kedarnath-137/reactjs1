...
class IncremProduct extends Component{
    constructor(){
        super()
        this.state={
            products:[
    ...
    decrement = (data) => {
        // console.log(data, this.state.products);
        let result1=this.state.products.map((eachObject) => {
            if(eachObject.id == data.id){
                let newObject1 = {
                    ...eachObject,rating : {
                        ...eachObject.rating,count : eachObject.rating.count-1
    ...
    render(){
        return(
            <div>
               ...
               <button onClick={() => {this.props.increment(this.props.data)}}>{this.props.increment}count add + </button>
               <button onClick={() => {this.props.decrement(this.props.data)}}>{this.props.decrement}count sub - </button>
               <button onClick = {() => {this.props.communication(this.props.data)}}>click to see products</button>

            {/* <button onClick={this.childToParent}>click here</button> // not coming. */}
            </div>
        )
    }
}
...
// <button> it is a lifting of state. 
// in button we use arrow function for passing a data. 

// we can call ProductListing where were we want. we can export then we use their.
